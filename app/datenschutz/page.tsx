        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-10">
              ...
              <p className="text-tavyro-text2 leading-relaxed mb-6">
            ...
            <div className="mb-10">
              ...
              <div className="space-y-4 text-tavyro-text2 leading-relaxed">
                <p>
                  <strong className="text-tavyro-text">Wer ist verantwortlich für die Datenerfassung auf dieser Website?</strong><br />
                ...
                <p>
                  <strong className="text-tavyro-text">Wie erfassen wir Ihre Daten?</strong><br />
                ...
                <p>
                  <strong className="text-tavyro-text">Wofür nutzen wir Ihre Daten?</strong><br />
                  Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu gewährleisten. 
                  Andere Daten können zur Analyse Ihres Nutzerverhaltens verwendet werden.
                </p>
                <p>
                  <strong className="text-tavyro-text">Welche Rechte haben Sie bezüglich Ihrer Daten?</strong><br />
            ...
            <h2 className="text-3xl font-bold text-tavyro-brand-700 mb-8 mt-12">
              2. Hosting
            </h2>
            ...
            <div className="mb-10">
              ...
              <div className="space-y-4 text-tavyro-text2 leading-relaxed">
                <p className="font-semibold text-tavyro-text uppercase text-sm">
                ...
                <p className="font-semibold text-tavyro-text uppercase text-sm">
                  ...
                  WENN SIE WIDERSPRECHEN, WERDEN IHRE PERSONENBEZOGENEN DATEN ANSCHLIESSEND NICHT MEHR ZUM ZWECKE DER DIREKTWERBUNG VERWENDET 
